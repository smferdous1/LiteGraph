...
/**
 * Run smoke tests for default and explicitly typed LightGraph construction.
 *
...
int main() {
    try {
        ...
        {
            LightGraph<float, unsigned int, unsigned int> g3(10, 20);
        ...
        std::cout << "\nTest 3: Testing custom types..." << std::endl;
        {
            ...
            std::cout << "  ✓ Created LightGraph<double, uint32_t, uint64_t>" << std::endl;
        }
